...
// import 'boxicons';
import moon from "../Images/moon-regular-24.png";
import sun from "../Images/sun-regular-24.png";
...
const Navbar = () => {
  ...
  const isLocalStroageAvailable =
    typeof window !== "undefined" && window.localStorage;
  const [selectedTheme, setSelectedTheme] = useState(
    isLocalStroageAvailable
      ? localStorage.getItem("selectedtheme") || "light"
      : null
  );
  const [selectedIcon, setSelectedIcon] = useState(
    isLocalStroageAvailable
      ? localStorage.getItem("selectedicon") || "bx-sun"
      : null
  );
        ...
        <nav className="navbar">
          <div className="logo_list">
            <svg xmlns="http://www.w3.org/2000/svg" width="121" height="33">
              <path
               className="fill_logo" fill="#34313D"
          ...
          <div className="header_btn">
            {/* <Image src={sun} alt="" width={20} height={20} onClick={toogletheme}/> */}
            <i
            ...
            <i
              className={navMenu ? "bx bx-x ham_menu" : "bx bx-menu ham_menu"}
              onClick={menuClick}
            ></i>
          </div>
        </nav>
